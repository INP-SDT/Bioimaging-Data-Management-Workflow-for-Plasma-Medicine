...
The json schema based file [Screen_schema.json](Screen_schema.json) contains all important fields for the OMERO annotation carried out by the Jupyter workflow.
